    ...
    protected void BuyProduct() {
        try {
            ...
            if (TextInvoiceId.getText().toString().isEmpty()) {
                Toast.makeText(getApplicationContext(), "Invoice id can not  be empty", Toast.LENGTH_LONG).show();
                valid = false;
            }

            if (TextQtyNeed.getText().toString().isEmpty()) {
                Toast.makeText(getApplicationContext(), "Quantity can not be empty", Toast.LENGTH_LONG).show();
                valid = false;
            }
